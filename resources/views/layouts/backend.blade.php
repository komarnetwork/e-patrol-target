...
<head>
    ...
    <meta name="description" content="E-PatrolTarget &amp; Security created by komarudin and published on Target Security">
                ...
                <div class="content-header bg-white-5">
                    ...
                    <a class="fw-semibold text-white tracking-wide" href="/">
                        <span class="smini-visible">
                            E-Patrol<span class="opacity-75">Target</span>
                        </span>
                    ...
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item{{ request()->is('pages/*') ? ' open' : '' }}">
                            ...
                            <ul class="nav-main-submenu">
                                <li class="nav-main-item">
                                    <a class="nav-main-link{{ request()->is('pages/userlist') ? ' active' : '' }}" href="{{ url('/pages/userlist') }}">
                                        <span class="nav-main-link-name">UserList</span>
                                    </a>
                                </li>
                                <li class="nav-main-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end p-0" aria-labelledby="page-header-user-dropdown">
                            ...
                            <div class="p-2">
                                ...
                                <form action="{{ route('logout') }}" method="post">
                                    ...
                                    <button type="submit" class="border-0"><i class="far fa-fw fa-arrow-alt-circle-left me-1"></i> Logout</button>
                                </form>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content py-0">
                <div class="row fs-sm">
                    <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-end">
                        Development <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" target="_blank">komarudin</a>
                    </div>
                    <div class="col-sm-6 order-sm-1 text-center text-sm-start">
                        <a class="fw-semibold" href="http://targetsecurindo.co.id/" target="_blank">PT Target Kelola Securindo</a> &copy;
