                    ...
                    <form class="js-validation-signin" id="jq-validation" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <div class="input-group input-group-lg">
                                <input type="text" class="form-control @if (session()->has('loginError')) is-invalid @endif" id="username" name="username" placeholder="Username" autofocus required>
                        ...
                        <div class="mb-4">
                            <div class="input-group input-group-lg">
                                <input type="password" class="form-control @if (session()->has('loginError')) is-invalid @endif" id="password" name="password" placeholder="Password" required>
                                <span class="input-group-text">
                        ...
                        <div class="d-sm-flex justify-content-sm-between align-items-sm-center text-center text-sm-start mb-4">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="remember-me" name="remember-me" {{ old('remember') ? 'checked' : '' }}>
